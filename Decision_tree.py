...
feature_importances = tree_clf.feature_importances_#özelliklerin değere etki etme ağırlığını veriyor
...
#max depth i artırma overfittinge yol açar
